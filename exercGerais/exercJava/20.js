...
function troco(valor) {
    ...
    if (valor >= 100) {
        ...
        console.log(total, "notas de R$ 100")
    }
    total = 0
    if (valor >= 50) {
        while (valor >= 50) {
        ...
        console.log(total, "notas de R$ 50")
    }
    total = 0
    if (valor >= 10) {
        while (valor >= 10) {
        ...
        console.log(total, "notas de R$ 10")
    }
    total = 0
    if (valor >= 5) {
        while (valor >= 5) {
        ...
        console.log(total, "notas de R$ 5")
    }
    total = 0
    if (valor >= 1) {
        while (valor >= 1) {
        ...
        console.log(total, "notas de R$ 1")
    }
